    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4>User Details
          <a class="btn btn-primary btn-sm float-right" href="{{url('users')}}">
            Back</a>
            </h4>
          <hr>
        </div>
        <div class="card-body">
          ...
          <div class="col-md-4 mt-3">
              ...
              <div class="p-2 border">{{$user->role_as == 'User' ? 'User' : 'Admin'}}</div>
            </div>
            <div class="col-md-4 mt-3">
            ...
            <div class="col-md-4 mt-3">
              ...
              <div class="p-2 border">{{$user->pnumber}}</div>
            </div>
            <div class="col-md-4 mt-3">
            ...
            <div class="col-md-4 mt-3">
              ...
              <div class="p-2 border">{{$user->pcode}}</div>
            </div>
          </div>
        </div>
      </div>
